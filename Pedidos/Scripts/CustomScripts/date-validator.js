...
@section Scripts {
    ...
    @Scripts.Render("~/Scripts/CustomScripts/customdate-validator.js")
}
*/
...
$.validator.addMethod("customdate",
    function (value, element, params) {
        return checkDate(value, params, true);
    },
    $("#customdate").val());
...
$.validator.unobtrusive.adapters.addSingleVal("customdate", "format");